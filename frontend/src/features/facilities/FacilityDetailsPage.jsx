              ...
              {dayWindows.length === 0 ? (
                ...
                <div className="flex flex-wrap gap-1.5">
                  {dayWindows.map((w, i) => (
                    <span
                      key={i}
                      className="rounded-md bg-white border border-gray-200 px-2 py-0.5 text-xs font-medium text-gray-700 shadow-sm"
                    >
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
        ...
        {hasTags && (
          <section
            className="rounded-lg border border-gray-200 bg-white p-5 md:col-span-2"
