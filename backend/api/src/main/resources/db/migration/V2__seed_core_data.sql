...
INSERT INTO public."user" (
    ...
    ('11111111-1111-1111-1111-111111111111', 'google-sub-admin-001', 'admin@smartcampus.edu', 'System Admin', true, NULL, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('22222222-2222-2222-2222-222222222222', 'google-sub-lecturer-001', 'lecturer@smartcampus.edu', 'Dr. Nimal Perera', true, NULL, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('33333333-3333-3333-3333-333333333333', 'google-sub-tech-001', 'tech@smartcampus.edu', 'S. Fernando', true, NULL, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('44444444-4444-4444-4444-444444444444', 'google-sub-fm-001', 'facility.manager@smartcampus.edu', 'A. Jayasekara', true, NULL, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('55555555-5555-5555-5555-555555555555', 'google-sub-student-001', 'student@smartcampus.edu', 'Pamali Student', true, NULL, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP)
...
ON CONFLICT DO NOTHING;-- Seed data for local/dev environments.
-- Uses stable UUIDs so related rows can reference each other.
